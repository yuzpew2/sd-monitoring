...
import { BackupIngestRequest, IngestResponse } from "@/lib/types";
...
export async function POST(request: NextRequest) {
    try {
        ...
        // Parse request body
        const body: BackupIngestRequest = await request.json();
        ...
        if (insertError) {
            ...
            console.error("Error inserting backup records:", insertError);
            return NextResponse.json(
        ...
        const response: IngestResponse = {
            ...
            message: `Successfully ingested ${body.data.length} backup records`,
        };
